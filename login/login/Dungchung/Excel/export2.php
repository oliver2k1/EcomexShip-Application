...
$sheet->mergeCells('C6:F6')->setCellValue('C6', 'CONG TY TNHH TM VA XNK  ZBA')->getStyle('C6')->getFont()->setBold(true);
$sheet->mergeCells('C7:F7')->setCellValue('C7', '27 Nghia Do  -Cau  Giay- Ha Noi');
...
$sheet->mergeCells('C10:F10')->setCellValue('C10', 'Mr.Cuong');
$sheet->mergeCells('C11:F11')->setCellValue('C11', "'0915975566");
...
$filename = 'OliverInvoice_'.$contactName.'_'.$time.'.xlsx';
