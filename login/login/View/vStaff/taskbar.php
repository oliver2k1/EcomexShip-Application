        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
              ...
              <ul class="menu-sub">
               <li class="menu-item">
                  <a href="list-all-barcode.php" class="menu-link">
                    <div data-i18n="Alerts">Tất cả - In mã vạch<span class="lex-shrink-0 badge bg-primary">
                  <?php 
                  $order = new order();
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="Form Layouts">Invoice, Tracking & Label</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="import-tracking.php" class="menu-link">
                    <div data-i18n="Vertical Form">Upload tracking</div>
                  </a>
                </li>
                <li class="menu-item">
