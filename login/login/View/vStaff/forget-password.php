            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.php" class="app-brand-link gap-2">
                        ...
                        <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                          <g id="Icon" transform="translate(27.000000, 15.000000)">
                            <g id="Mask" transform="translate(0.000000, 8.000000)">
                              ...
                              <use fill="#2C65AF" xlink:href="#path-1"></use>
                              <g id="Path-3" mask="url(#mask-2)">
                                <use fill="#2C65AF" xlink:href="#path-3"></use>
                                <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-3"></use>
                              </g>
                              <g id="Path-4" mask="url(#mask-2)">
                                <use fill="#2C65AF" xlink:href="#path-4"></use>
                            ...
                            >
                              <use fill="#2C65AF" xlink:href="#path-5"></use>
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Ecomex</span>
                </a>
              </div>
              <!-- /Logo -->
