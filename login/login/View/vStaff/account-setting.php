                ...
                <div class="col-md-12">
                  ...
                  ?>
                    <div class="card-body">
                      ...
                      <img src="<?php echo $_SESSION["avatar"]; ?>" alt="Ảnh đại diện" style="max-width: 200px; height: auto;">
                        <div class="button-wrapper">
                          ...
                          <p class="text-muted mb-0">Được phép JPG hoặc PNG. Kích thước tối đa 5MB</p>
                        </div>
                      </div>
                    </div>
                    <hr class="my-0" />
