                ...
                <div class="col-md-6">
                  ...
                  ?>
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <?php
                      if ($result_order['trangthai'] == 2  || $result_order['trangthai'] == 4) {
                    ...
                    <div class="mb-3" >
                      ...
                      <div class="mb-3">
                        ...
                        <input
                        <?php if($result_order['trangthai']!=0){echo "readonly";} ?>
                          type="text"
                          class="form-control"
                  ...
                  <div class="card mb-4">
                   ...
                   <div class="mb-3">
                        ...
                        <?php
                         if($result_order['trangthai']!=6 && $result_order['trangthai']!=0 || $result_order['service']!==''){
                      ...
                      <div class="mb-3">
                        ...
                        <input autocomplete="OFF" type="text" <?php if($result_order['trangthai']!=0){echo "readonly";} ?> class="form-control" id="product" name="product" placeholder="Nhập tên sản phẩm" value="<?php echo htmlspecialchars($result_order['name_product']) ?>">
                      </div>
                      <div class="mb-3">
                        <label for="exampleFormControlSelect1" class="form-label">Số lượng gói hàng</label>
                        <input  type="number" <?php if($result_order['trangthai']!=0){echo "readonly";} ?> class="form-control" id="product" name="quantity" required="" min="1" placeholder="Nhập số kiện hàng" value="<?php echo htmlspecialchars($result_order['quantity']) ?>">
                      </div>
                      <label for="x" class="form-label">Kích thước (cm) - Dim (gam)</label>
                      <div class="input-group" class="mb-3">
                        <input name="length"  required type="number" id="dai" <?php if( $result_order['trangthai']!= 0 &&   $result_order['trangthai']!= 6){echo "readonly";} ?> <?php if( $result_order['trangthai']!= 0){ echo 'min = "1"'; } ?>  class="form-control" placeholder="Chiều dài" value="<?php echo htmlspecialchars($result_order['length']) ?>"/>
                        <input name="width"  required type="number"  id="rong" <?php if( $result_order['trangthai']!= 0 &&   $result_order['trangthai']!= 6){echo "readonly";} ?> <?php if( $result_order['trangthai']!= 0){ echo 'min = "1"'; } ?>  class="form-control" placeholder="Chiều rộng" value="<?php echo htmlspecialchars($result_order['width']) ?>"/>
                        <input name="height"  required type="number"  id="cao" <?php if( $result_order['trangthai']!= 0 &&  $result_order['trangthai']!= 6){echo "readonly";} ?> <?php if( $result_order['trangthai']!= 0){ echo 'min = "1"'; } ?>  class="form-control" placeholder="Chiều cao" value="<?php echo htmlspecialchars($result_order['height']) ?>"/>
                    ...
                    <div class="mb-3">
                      ...
                      <input name="weight" id="weight" type="number" step="1" <?php if( $result_order['trangthai']!= 0){ echo 'min = "1"'; } ?>  required aria-label="First name" <?php if( $result_order['trangthai']!= 0 &&  $result_order['trangthai']!= 6){echo "readonly";} ?> class="form-control" placeholder="Cân nặng" value="<?php echo htmlspecialchars($result_order['weight']) ?>"/>
                    </div>
                    <div class="mb-3">
                      <label for="x2" class="form-label" >Chiết khấu (%)</label>
                      <input name="disscount" id="disscount" step="1" type="number" min="0" max="100"  <?php if( $result_order['trangthai']!= 0 &&  $result_order['trangthai']!= 6 ){echo "readonly";} ?>
                    ...
                    <div class="mb-3">
                      ...
                      <?php if( $result_order['trangthai']!= 0){ echo 'required'; } ?> <?php if( $result_order['trangthai']!= 0 &&  $result_order['trangthai']!= 6 ){echo "readonly";} ?> class="form-control"  placeholder="Nhập phụ phí" value="<?PHP if($result_order['trangthai']!= 0&&$result_order['trangthai']!= 6 ){echo $result_order['fee'];} ?>"/>
                    </div>
                    <div class="mb-3">
