            ...
            <div class="container-xxl flex-grow-1 container-p-y">
             <div class="card">
                ...
                <?php
                  ...
                  $count_query = "SELECT COUNT(id) AS total FROM oder Where `status` = 1 AND `service` = 'Epacket-USA' AND (`trangthai` = 1 OR `trangthai` = 7 OR `trangthai` = 8)";
                  ...
                  $order_result = $order->show_order_all_staff($offset,$per_page);
                ?>
