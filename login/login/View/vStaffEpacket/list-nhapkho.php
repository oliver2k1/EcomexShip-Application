             ...
             <div class="card">
                <h5 class="card-header">Đơn hàng đã nhập kho</h5>
                  <?php
                      ...
                      $count_query = "SELECT COUNT(id) AS total FROM oder WHERE `status` = 1 AND `trangthai` = 7 AND `service` = 'Epacket-USA'";
                      ...
                      $order_result = $order->show_order_nhapkho_epacket($offset, $per_page);
                    ?>
