            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  ...
                  <?php 
                  $order = new order();
                  $count = $order->show_number_order_epacket();
                  echo $count;
                  ?>
                   </span></div>
                  </a>
                ...
                <li class="menu-item">
                  ...
                  <?php 
                  $order = new order();
                  $count = $order->show_number_order_transporting_epacket();
                  echo $count;
                  ?></span></div>
                  </a>
                </li>
                <li class="menu-item">
                  ...
                  <?php 
                  $order = new order();
                  $count = $order->show_number_order_nhapkho_epacket();
                  echo $count;
                  ?></span></div>
                  </a>
                </li>
                <li class="menu-item">
                  ...
                  <?php 
                  $order = new order();
                  $count = $order->show_number_order_xuatkho_epacket();
                  echo $count;
                  ?></span></div>
                  </a>
                </li>
