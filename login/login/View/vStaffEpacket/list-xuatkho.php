             ...
             <div class="card">
                <h5 class="card-header">Đơn hàng đã xuất kho</h5>
                  <?php
                      ...
                      $count_query = "SELECT COUNT(id) AS total FROM oder WHERE `status` = 1 AND `trangthai` = 8 AND `service` = 'Epacket-USA'";
                      ...
                      $order_result = $order->show_order_xuatkho_epacket($offset, $per_page);
                    ?>
