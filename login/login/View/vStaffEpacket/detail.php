                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="mb-3">
                        ...
                        <input type = "text" value="<?php echo 'ID'.htmlspecialchars($result_order['idOrder']).'ECOMEX' ?>" readonly class="form-control"></input>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                       ...
                       <div class="mb-3">
                        <label for="exampleFormControlSelect1" class="form-label">Tên kiện hàng</label>
                        <input type = "text" readonly value="<?php echo $result_order['kienhang'] ?>" class="form-control"></input>
                      </div>
                      <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type = "text" readonly type="text" aria-label="First name" class="form-control" value="<?php echo $result_order['fee'].' VNĐ' ?>" readonly />
                    </div>
                    <label for="price" class="form-label">Chiết khấu (%)</label>
                    <div class="input-group mb-3">
                      <label for="price" class="form-control" >Chiết khấu</label>
                      <input type = "text" readonly type="text" class="form-control" value="<?php echo $result_order['disscount'].'%' ?>" readonly />
                    </div>
                    <label for="price" class="form-label">Thành tiền (VNĐ)</label>
                    <div class="input-group mb-3">
                      <label for="price" class="form-control" >Thành tiền</label>
                      <input type = "text" readonly type="text" aria-label="First name" class="form-control" value="<?php $formatPrice = number_format($result_order['price'], 0, ',', '.').' VNĐ';
                         echo $formatPrice; ?>" readonly />
                    </div>
