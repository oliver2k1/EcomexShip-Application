...
?>
        ...
        <div class="content-wrapper">
            ...
            $row = getKienhang($id);//lấy thông tin dịch vụ theo id   
            ?>   
      <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
          <div class="col-md-12">
            <div class="card mb-4">
              <h5 class="card-header">Sửa thông tin kiện hàng</h5>
              <div class="card-body">
                <form action="../../Controller/ctrAdmin/update-kienhang.php">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="mb-3">
                        <label for="firstName" class="form-label">Tên kiện hàng</label>
