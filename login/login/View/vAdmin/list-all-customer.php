...
?>
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
             <div class="card">
             <form action="../../Dungchung/payment2.php" method="post" target="_blank">
                <h5 class="card-header">Danh sách đơn hàng <button type="submit" name="submit" class="btn btn-primary"> Thanh toán</button></h5>
                <?php
                ...
                <?php
                  ...
                  $count_query = "SELECT COUNT(id) AS total FROM oder Where `status` = 1";
                  ...
                  $order_result = $order->show_order_all_admin($offset,$per_page);
                ?>
                ...
                <?php
                  ...
                  for ($i = $start_page; $i <= $end_page; $i++) {
                    if ($i == $current_page) {
                      ...
                      echo "<li class='page-item'><a class='page-link' href='list-all-customer.php?page=".$i."'>".$i."</a></li>";
                    }
                  }
                  echo "</ul>";
                  echo "</nav>";
