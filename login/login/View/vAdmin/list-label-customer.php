...
?>
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
             <div class="card">
                <h5 class="card-header">Đơn hàng tạo nhãn label</h5>
                <?php
                ...
                <?php
                  ...
                  $count_query = "SELECT COUNT(id) AS total FROM oder WHERE `status` = 1 AND `trangthai` = 6";
                  ...
                  $order_result = $order->show_order_label($offset,$per_page);
                ?>
                      ...
                      ?>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <a class="dropdown-item" onclick="return confirm('Bạn có chắc chắn muốn xóa đơn hàng này?')" href="list-all-customer.php?idOrder=<?php echo $result['idOrder'] ?>"><i class="bx bx-trash me-1"></i> Xóa đơn hàng</a>
                            </div>
                          </div>
                        </td>
                        </tr>
                ...
                <?php
                  ...
                  for ($i = $start_page; $i <= $end_page; $i++) {
                    if ($i == $current_page) {
                      ...
                      echo "<li class='page-item'><a class='page-link' href='list-label-customer.php?page=".$i."'>".$i."</a></li>";
                    }
                  }
                  echo "</ul>";
                  echo "</nav>";
