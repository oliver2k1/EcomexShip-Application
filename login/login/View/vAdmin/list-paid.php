...
?>
          <div class="content-wrapper">
            ...
            <form action="../../Dungchung/payment.php" method="post" >
             <div class="card">
                <h5 class="card-header">Đơn hàng đã thanh toán </h5>
                <?php
                ...
                <?php
                  ...
                  $order_result = $order->show_order_paid($offset,$per_page);
                ?>
                      ...
                      ?>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <a class="dropdown-item" onclick="return confirm('Bạn có chắc chắn muốn xóa đơn hàng <?php echo $result['idOrder'] ?>?')" href="list-paid.php?idOrder=<?php echo $result['idOrder'] ?>"><i class="bx bx-trash me-1"></i> Xóa đơn hàng</a>
                            </div>
                          </div>
                        </td>
                        </tr>
                ...
                <?php
                  ...
                  for ($i = $start_page; $i <= $end_page; $i++) {
                    if ($i == $current_page) {
                      ...
                      echo "<li class='page-item'><a class='page-link' href='list-paid.php?page=".$i."'>".$i."</a></li>";
                    }
                  }
                  echo "</ul>";
                  echo "</nav>";
