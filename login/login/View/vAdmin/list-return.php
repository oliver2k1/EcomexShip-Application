...
?>
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
             <div class="card">
                <h5 class="card-header">Đơn hàng chú ý</h5>
                <?php
                ...
                <?php
                  ...
                  $count_query = "SELECT COUNT(id) AS total FROM oder WHERE `status` = 1 AND `trangthai` = 3";
                  ...
                  $order_result = $order->show_order_return_admin($offset, $per_page);
                ?>
                      ...
                      ?>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <a class="dropdown-item" onclick="return confirm('Bạn có chắc chắn muốn xóa đơn hàng <?php echo $result['idOrder'] ?>?')" href="list-return.php?idOrder=<?php echo $result['idOrder'] ?>"><i class="bx bx-trash me-1"></i> Xóa đơn hàng</a>
                            </div>
                          </div>
                        </td>
                        </tr>
