    ...
    <div style="display:flex">
      ...
      <button id="add-service" style="margin: 10px 0" type="button" class="btn btn-outline-primary" data-bs-target="#collapseExample" data-bs-toggle="collapse">Thêm kiện hàng</button>
        ...
        <div class="collapse" id="collapseExample"> 
          <form action="../../Controller/ctrAdmin/add-kienhang.php">
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" style="cursor:pointer" href="edit-kienhang.php?id=<?=$row["id"]?>"
                                ><i class="bx bx-edit-alt me-1"></i>Sửa</a
                              >
                              <a class="dropdown-item" onclick="return confirm('Bạn có chắc chắn muốn xóa kiện hàng này?')" href="../../Controller/ctrAdmin/delete-kienhang.php?id=<?=$row["id"]?>"
