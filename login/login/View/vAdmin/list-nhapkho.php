...
?>
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
             <div class="card">
                <h5 class="card-header">Đơn hàng đã nhập kho</h5>
                <?php
                ...
                ?>
                  <?php
                      ...
                      $count_query = "SELECT COUNT(id) AS total FROM oder WHERE `status` = 1 AND `trangthai` = 7";
                      ...
                      $order_result = $order->show_order_nhapkho($offset, $per_page);
                    ?>
                      ...
                      ?>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <a class="dropdown-item" onclick="return confirm('Bạn có chắc chắn muốn xóa đơn hàng này?')" href="list-nhapkho.php?idOrder=<?php echo $result['idOrder'] ?>"><i class="bx bx-trash me-1"></i> Xóa đơn hàng</a>
                            </div>
                          </div>
                        </td>
                        </tr>
                ...
                <?php
                  ...
                  for ($i = $start_page; $i <= $end_page; $i++) {
                    if ($i == $current_page) {
                      ...
                      echo "<li class='page-item'><a class='page-link' href='list-nhapkho.php?page=".$i."'>".$i."</a></li>";
                    }
                  }
                  echo "</ul>";
                  echo "</nav>";
