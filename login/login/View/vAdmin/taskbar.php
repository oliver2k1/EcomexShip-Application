...
include_once("../../Model/tblService.php");
include_once("../../Model/tblKienhang.php");
?>
<?php 
$order = new Order();
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Authentications">Đăng ký tài khoản</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="register-staff.php" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Nhân viên</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="register-staff2.php" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Nhân viên kho</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="register-staff3.php" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Nhân viên hỗ trợ</div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="./list-new.php" class="menu-link">
                    <div data-i18n="Badges">Chờ xử lý <span class="flex-shrink-0 badge bg-warning">
                  <?php 
                  $order = new order();
                ...
                <li class="menu-item">
                  ...
                  <?php 
                  $order = new order();
                  $count = $order->show_number_order_label();
                  echo $count;
                  ?>
                   </span></div>
                  </a>
                ...
                <li class="menu-item">
                  ...
                  <?php 
                  $order = new order();
                  $count = $order->show_number_order_transporting();
                  echo $count;
                  ?></span></div>
                  </a>
                </li>
                <li class="menu-item">
                  ...
                  <?php 
                  $order = new order();
                  $count = $order->show_number_order_nhapkho();
                  echo $count;
                  ?></span></div>
                  </a>
                </li>
                <li class="menu-item">
                  ...
                  <?php 
                  $order = new order();
                  $count = $order->show_number_order_xuatkho();
                  echo $count;
                  ?></span></div>
                  </a>
                </li>
                <li class="menu-item">
                  ...
                  <?php 
                  $order = new order();
                  $count = $order->show_number_order_ship();
                  echo $count;
                  ?></span></div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="./list-done.php" class="menu-link">
                    <div data-i18n="Collapse">Đơn hoàn thành <span class="flex-shrink-0 badge bg-success">
                    <?php 
                  $order = new order();
                  $count = $order->show_number_order_done();
                  echo $count;
                  ?></span>
                    </div>
                  </a>
                ...
                <li class="menu-item">
                  <a href="list-unpaid.php" class="menu-link">
                    ...
                    <?php 
                  $order = new order();
                  $count = $order->show_number_order_unpaid();
                  echo $count;
                  ?></span></div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="list-paid.php" class="menu-link">
                    ...
                    <?php 
                  $order = new order();
                  $count = $order->show_number_order_paid();
                  echo $count;
                  ?></span></div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="./list-return.php" class="menu-link">
                    ...
                    <?php 
                  $order = new order();
                  $count = $order->show_number_order_return();
                  echo $count;
                  ?></span></div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="./list-cancel.php" class="menu-link">
                    ...
                    <?php 
                  $order = new order();
                  $count = $order->show_number_order_cancel();
                  echo $count;
                  ?></span></div>
                  </a>
                </li>
            ...
            <li class="menu-item"> 
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Form Layouts">Danh sách kiện hàng</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="./kienhang.php" class="menu-link">
                    <div data-i18n="Vertical Form">Danh sách kiện hàng</div>
                  </a>
                </li>
                <?php
                    ...
                    ?>
                <li class="menu-item">
                  <a href="list-kienhang.php?kienhang=<?php echo $row["name"] ?>" class="menu-link">
                    <div data-i18n="Vertical Form"><?php echo $row["name"]?></div>
                  </a>
                </li>
                <?php
                    }
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="./list-finances.php" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Tài chính (ngày)</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="./list-finances2.php" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Tài chính (tháng)</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="./list-finances3.php" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Tài chính (khách hàng)</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="./list-congno.php" class="menu-link">
                    <div data-i18n="Text Divider">Công nợ</div>
                  </a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="./list-fee.php" class="menu-link">
                    <div data-i18n="Text Divider">Chi phí</div>
                  </a>
                </li>
              </ul>
            </li>
        <!-- Tables -->
         <li class="menu-header small text-uppercase" style="color: #000;"><span class="menu-header-text">Chức năng khác</span></li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="export-data.php" class="menu-link">
                    <div data-i18n="Vertical Form">Tất cả</div>
                  </a>
                </li>
              </ul>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="export-data-customer.php" class="menu-link">
                    <div data-i18n="Vertical Form">Theo khách hàng</div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="./delivery-service.php" class="menu-link">
                    <div data-i18n="Vertical Form">Bảng giá dịch vụ</div>
                  </a>
                </li>
                <?php
                    $rows = getNameService();
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="Form Layouts">Thông báo</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="./notification.php" class="menu-link">
                    <div data-i18n="Vertical Form">Danh sách thông báo</div>
                  </a>
                </li>
              </ul>
            </li>
