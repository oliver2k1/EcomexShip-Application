            ...
            <div class="container-xxl flex-grow-1 container-p-y">
             <div class="card">
                ...
                <?php
                  ...
                  $count_query = "SELECT COUNT(id) AS total FROM oder WHERE `status` = 1 AND `trangthai` = 4 AND `name_user` = '$name_user'";
                  ...
                  $offset = ($current_page - 1) * $per_page;                  $name_user = $_SESSION['name'];
                  // Lấy danh sách đơn hàng cho trang hiện tại
                  $order_result = $order->show_order_cancel($offset, $per_page,$name_user);
                ?>
