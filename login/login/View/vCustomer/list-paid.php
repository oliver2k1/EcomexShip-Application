...
?>
          <div class="content-wrapper">
            ...
            <form action="../../Dungchung/payment.php?id_user=<?php echo $_SESSION["id"] ?>" method="post" >
             <div class="card">
                ...
                <?php
                  ...
                  $order_result = $order->show_order_paid_customer($offset,$per_page,$name_user);
                ?>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php if($result['payment']!=1&&$result['trangthai']!=0&&$result['trangthai']!=''&&$result['price']!=0&&$result['price']!=''){
