            ...
            <form action="../../Dungchung/payment.php?id_user=<?php echo $_SESSION["id"] ?>" method="post" target="_blank">
             <div class="card">
                ...
                <?php
                  ...
                  $count_query = "SELECT COUNT(id) AS total FROM oder WHERE `status` = 1 AND `trangthai` = 0 AND `name_user` = '$name_user'";
                  ...
                  $order_result = $order->show_order_new($offset,$per_page,$name_user);
                ?>
