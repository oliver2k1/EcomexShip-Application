              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  <form class="d-flex" action="result.php" method="get">
                    ...
                    <input type="hidden"  name="name_user" class="form-control" value="<?php echo $_SESSION['name'] ?>">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    ...
                    <img src="<?php echo $_SESSION["avatar"]; ?>" alt class="w-px-40 h-px-40 rounded-circle" />
                    </div>
                  </a>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel1">Admin</h5>
                        <button
                          type="button"
                          class="btn-close"
                          data-bs-dismiss="modal"
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row g-2">
                          ...
                          <div class="col mb-0">
                            ...
                            <input type="text" id="emailBasic" class="form-control" value="Hà Ecomex"readonly/>
                          </div>
                        </div>
                      </div>
                    </div>
                            ...
                            <div class="chat-container">
                                ...
                                <div class="user-list">
                                    <ul class="list-group" id="user-list">
                                      ...
                                      WHERE u.name != '$currentUsername' AND u.quyen != 3 AND u.quyen != 4
